...
public class ImportCertificationApprovalTaskDetailsService {
	...
	public static void execute() {
		...
		try {
			...
			List<Map<String, Object>> rows = ImportCertificationApprovalTaskDetailsFunctions.readSourceCertificationApprovalTaskDetails(limit);
			...
			while(!rows.isEmpty()) {
				...
				ImportCertificationApprovalTaskDetailsFunctions.saveTargetCertificationApprovalTaskDetails(rows);
				
				rows = ImportCertificationApprovalTaskDetailsFunctions.readSourceCertificationApprovalTaskDetails(limit);
	...
	private static void createImportValidationField() throws Exception {
		...
		try {
			...
			String sql = "alter table CertificationApprovalTaskDetail add column _imported_ int default 0";
	...
	private static void deleteImportValidationField() throws Exception {
		...
		String sql = "alter table CertificationApprovalTaskDetail drop column _imported_";
