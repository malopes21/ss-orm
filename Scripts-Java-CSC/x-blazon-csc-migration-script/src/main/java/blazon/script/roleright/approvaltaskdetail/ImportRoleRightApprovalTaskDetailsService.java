...
public class ImportRoleRightApprovalTaskDetailsService {
	...
	public static void execute() {
		...
		LOGGER.log(Level.INFO, "Iniciando importação de RoleRight Approval Task Details ...");
		...
		try {
			...
			List<Map<String, Object>> rows = ImportRoleRightApprovalTaskDetailsFunctions.readSourceRoleRightApprovalTaskDetails(limit);
			...
			while(!rows.isEmpty()) {
				...
				ImportRoleRightApprovalTaskDetailsFunctions.saveTargetRoleRightApprovalTaskDetails(rows);
				
				rows = ImportRoleRightApprovalTaskDetailsFunctions.readSourceRoleRightApprovalTaskDetails(limit);
		...
		LOGGER.info("Finalizado importação de RoleRight Approval Task Details!");
	}
	...
	private static void createImportValidationField() throws Exception {
		...
		try {
			...
			String sql = "alter table RoleRightApprovalTaskDetail add column _imported_ int default 0";
	...
	private static void deleteImportValidationField() throws Exception {
		...
		String sql = "alter table RoleRightApprovalTaskDetail drop column _imported_";
