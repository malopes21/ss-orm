...
lockDate	datetime	YES		NULL	
lockNumber	bigint(20)	YES		NULL	
membershipId	bigint(20)	YES		NULL	
needApproval	bit(1)	NO		NULL	
operationWorkflowId	bigint(20)	YES		NULL	
...
uncertifiedEntryAction	varchar(255)	YES		NULL	
TABLE_NAME
...
newOwner_id	bigint(20)	YES		NULL	
resolvedBy_id	bigint(20)	YES		NULL	
TABLE_NAME
...
relatedCatalogItemId	varchar(255)	YES		NULL	
relatedCatalogItemName	varchar(255)	YES		NULL	
schemaValidated	bit(1)	YES		NULL	
userId	varchar(255)	YES		NULL	
cartItem_id	bigint(20)	YES		NULL	
...
catalogItemId	varchar(255)	YES		NULL	
cart_id	bigint(20)	YES		NULL	
TABLE_NAME
ServerMailSetup
ServerMailSetup
Field	Type	Null	Key	Default	Extra
...
workflowId	bigint(20)	YES		NULL	
beneficiary_id	bigint(20)	YES	MUL	NULL	
sodInternalEntry_id	bigint(20)	YES	MUL	NULL	
TABLE_NAME
...
queueTo_id	bigint(20)	YES	MUL	NULL	
userFrom_id	bigint(20)	YES	MUL	NULL	
userTo_id	bigint(20)	YES	MUL	NULL	
TABLE_NAME
