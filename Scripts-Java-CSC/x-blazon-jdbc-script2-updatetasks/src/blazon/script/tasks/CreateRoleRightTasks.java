...
public class CreateRoleRightTasks {
	
	
	public static void main(String[] args) {
		
		CreateRoleRightTasks.createApprovalTasks();
	}
	...
	public static void createApprovalTasks() {
		...
		try {
			...
			for(int i=24000; i<24010; i++) {
				...
				statement.setString(2, "ROLE_RIGHT_TASK");
				statement.setString(3, "ROLERIGHT");
				...
				sql = " insert into RoleRightApprovalTask (id, roleRightEntry_id) \n" + 
						"				values (?, ?) ";
