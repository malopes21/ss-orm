...
public class CreateRequestSodTasks {
	
	
	public static void main(String[] args) {
		
		CreateRequestSodTasks.createApprovalTasks();
	}
	...
	public static void createApprovalTasks() {
		...
		try {
			...
			for(int i=8000; i<10000; i++) {
				...
				statement.setString(2, "REQUEST_SOD_TASK");
				...
				sql = " insert into BlazonRequestSodApprovalTask (id, request_id) \n" + 
						"				values (?, ?) ";
				...
				statement = conn.prepareStatement(sql);
				statement.setLong(1, i);
				statement.setLong(2, certificationId + 124);
