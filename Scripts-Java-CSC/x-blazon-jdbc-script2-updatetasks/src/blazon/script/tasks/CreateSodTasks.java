...
public class CreateSodTasks {
	
	
	public static void main(String[] args) {
		
		CreateSodTasks.createApprovalTasks();
	}
	...
	public static void createApprovalTasks() {
		...
		try {
			...
			for(int i=6000; i<8000; i++) {
				...
				statement.setString(2, "SOD_TASK");
				statement.setString(3, "SODENTRY");
				...
				sql = " insert into SodApprovalTask (id, sodEntry_id) \n" + 
						"				values (?, ?) ";
